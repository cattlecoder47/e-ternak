                ...
                <form action="#" class="form-horizontal">
                    <div class="modal-body">
                        <div class="form-group row">
                            <label class="col-form-label col-sm-3">Nama Jenis Identitas</label>
                            <div class="col-sm-9">
                                <input type="text" placeholder="Nama Jenis Identitas" wire:model="rjid_nama"
                                       id="rjid_nama"
                                       class="form-control" required>
                                @error('rjid_nama') <label id="basic-error" class="validation-invalid-label"
