                ...
                <form action="#" class="form-horizontal">
                    <div class="modal-body">
                        <div class="form-group row">
                            <input type="hidden" wire:model="sysrole_kode">
                            <label class="col-form-label col-sm-3">Nama Role</label>
                            <div class="col-sm-9">
                                <input type="text" placeholder="Nama Role" wire:model="sysrole_nama"
                                       id="sysrole_nama"
                                       class="form-control" required>
                                @error('sysrole_nama') <label id="basic-error" class="validation-invalid-label"
